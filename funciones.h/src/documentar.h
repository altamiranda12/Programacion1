...
#ifndef DOCUMENTAR_H_
#define DOCUMENTAR_H_

	float sumar(float a, float b){
	/**\brief Ingreso de dos datos por el usuario y devuelve por pantalla el resultado
	 *\param a : es un valor float ingresado por el usuario
	 *\param b : es un valor float ingresado por el usuario
...
int factorial (int a){
	/**\brief Ingreso de un dato por el usuario y devuelve por pantalla el resultado
		 ...
		 *\while : hacemos la validacion de la variable "a" , para poder realizar el factorial del mismo
		 *\while : siempre y cuando el numero sea un entero y mayor a 0 de lo contrario el usuario
		 *\while : debera ingresar nuevamente otro valor a la  variable "a"
		 *\ return devuele el factorial de la variable "a"
		 */
